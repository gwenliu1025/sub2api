...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/gwenliu1025/sub2api:0.2.7
...
SUB2API_IMAGE=ghcr.io/gwenliu1025/sub2api:0.2.7 # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
