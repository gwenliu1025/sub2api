...
curl -sSL https://raw.githubusercontent.com/gwenliu1025/sub2api/v0.2.8/deploy/docker-deploy.sh | bash

# Or download first, then run
curl -sSL https://raw.githubusercontent.com/gwenliu1025/sub2api/v0.2.8/deploy/docker-deploy.sh -o docker-deploy.sh
...
```bash
# Clone repository
git clone --branch v0.2.8 --depth 1 https://github.com/gwenliu1025/sub2api.git
cd sub2api/deploy
...
# 确认使用 fork 的精确版本镜像：
grep -Fx 'SUB2API_IMAGE=ghcr.io/gwenliu1025/sub2api:0.2.8' .env
...
```bash
curl -sSL https://raw.githubusercontent.com/gwenliu1025/sub2api/v0.2.8/deploy/install.sh | sudo bash
```

### Manual Installation

1. Download v0.2.8 from [GitHub Releases](https://github.com/gwenliu1025/sub2api/releases/tag/v0.2.8)
