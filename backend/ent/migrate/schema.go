...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "raw_input_tokens", Type: field.TypeInt, Nullable: true},
		{Name: "raw_output_tokens", Type: field.TypeInt, Nullable: true},
		{Name: "raw_cache_read_tokens", Type: field.TypeInt, Nullable: true},
		{Name: "raw_cache_creation_tokens", Type: field.TypeInt, Nullable: true},
		{Name: "raw_cache_creation_5m_tokens", Type: field.TypeInt, Nullable: true},
		{Name: "raw_cache_creation_1h_tokens", Type: field.TypeInt, Nullable: true},
		{Name: "usage_allocation_version", Type: field.TypeInt16, Nullable: true},
		{Name: "usage_allocation_kind", Type: field.TypeInt16, Nullable: true},
