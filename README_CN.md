...
运维细节请参阅[Kiro-Go 原生 usage 计费说明](docs/EQUIVALENT_CACHE_BILLING_CN.md)和
...
remote compaction、compact 心跳和 Anthropic 缓存创建用量修复。本 fork 同时保留
自有 Release、Docker 更新元数据和原生 Anthropic usage 解析。Kiro-Go 负责生成
标准 usage，Sub2API 不再执行 Equivalent Cache V1/V2 的用量重写或审计分配。
