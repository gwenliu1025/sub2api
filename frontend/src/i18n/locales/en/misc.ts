export default {
  ...
  version: {
    ...
    preparingImage: 'Pulling and verifying image...',
    imagePrepared: 'Image Prepared',
    activatePrepared: 'Restart to switch to the prepared version',
    activatingImage: 'Switching to the prepared image...',
    waitingForHealth: 'Waiting for the new version to become healthy...',
    activationSucceeded: 'Switched to the new version successfully',
    activationRolledBack: 'The previous version was restored automatically',
    activationRollbackFailed: 'Automatic rollback failed',
    activationFailed: 'Activation failed',
    activationTimedOut: 'Activation timed out',
    manualRecoveryRequired:
      'URGENT: Manual recovery is required. Restore a known-good version with the manual rollback procedure and inspect the service logs.',
