export default {
  ...
  version: {
    ...
    updating: '正在更新...',
    prepareImage: '准备镜像',
    preparingImage: '正在拉取并校验镜像...',
    imagePrepared: '镜像已准备好（尚未切换）',
    activatePrepared: '重启以切换到已准备好的版本',
    activatingImage: '正在切换到已准备好的镜像...',
    waitingForHealth: '正在等待新版本通过健康检查...',
    activationSucceeded: '已成功切换到新版本',
    activationRolledBack: '新版本未通过健康检查，已自动恢复上一版本',
    activationRollbackFailed: '自动回滚失败',
    activationFailed: '切换新版本失败',
    activationTimedOut: '等待新版本生效超时',
    manualRecoveryRequired:
      '严重：需要立即人工恢复。请使用手工回滚方式恢复可用版本，并检查服务日志。',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
